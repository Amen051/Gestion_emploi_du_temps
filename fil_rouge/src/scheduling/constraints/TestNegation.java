...
public class TestNegation {
    ...
    public static void main(String[] args) {
        ...
        ok = ok && neg.getActivities().contains(acts);

        System.out.println(ok ? "All tests passed of NegationConstraint passed" : "At least one test of NegationConstraint FAILED");
    }
}
